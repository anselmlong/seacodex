...
export const singaporeNodes: SocialNode[] = [
  { id: "n1", segmentId: "gen-z-students", label: "Poly group chat", influence: 0.62 },
  { id: "n2", segmentId: "gen-z-students", label: "Hall Telegram", influence: 0.76 },
  { id: "n3", segmentId: "young-professionals", label: "CBD lunch crew", influence: 0.58 },
  { id: "n4", segmentId: "young-professionals", label: "BTO planning chat", influence: 0.71 },
  { id: "n5", segmentId: "parents-family", label: "Parent circle", influence: 0.82 },
  { id: "n6", segmentId: "parents-family", label: "Family WhatsApp", influence: 0.9 },
  { id: "n7", segmentId: "heartland-value", label: "Neighbourhood deals", influence: 0.69 },
  { id: "n8", segmentId: "heartland-value", label: "Voucher hunters", influence: 0.74 },
  { id: "n9", segmentId: "live-resellers", label: "Live seller pod", influence: 0.8 },
  { id: "n10", segmentId: "category-enthusiasts", label: "Creator fandom", influence: 0.88 },
  { id: "n11", segmentId: "category-enthusiasts", label: "Review thread", influence: 0.72 },
  { id: "n12", segmentId: "live-resellers", label: "Supplier chat", influence: 0.57 }
];
